...
retrieve_token(QsBodyIn, OpenIdProviderInfo) ->
    retrieve_token(QsBodyIn, undefined, OpenIdProviderInfo).

retrieve_token(QsBodyIn, Pkce, OpenIdProviderInfo) ->
    #{client_id := ClientId,
